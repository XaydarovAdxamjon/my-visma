            ...
            <div className="company">
                <div className="container">
                    ...
                    <div className="Company__video">
                        ...
                        <div onClick={()=> router.push('./register')} className="company__info__box">
                            <div className="box__text1">Запрос ставки и условий погрузочно-разгрузочных работ</div>
                            <div className="box__text2">Рассчитайте моментально стоимость полных портовых услуг в порту VISMA</div>
                        </div>
                    </div>
                </div>
            </div>
